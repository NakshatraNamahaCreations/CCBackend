...
const { createOrUpdateLead, addQueryAndPerson, getAllLeads, getAllQueriesPaginated, searchLeadByPhoneNo, searchLeadByPhonePrefix, getLeadWithSpecificQuery, updateQueryStatus, getLeadQueryDetails, updateLeadQueryDetails} = require('../Controllers/leadController');
